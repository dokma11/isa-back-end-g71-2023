...
-- sifra je legenda11
--insert into company_administrator(id, company_information, city, username,enabled, last_password_reset_date, name, password, profession,  state, surname, telephone_number, company_id, role_id) values(2, 'Iz dobre kompanije', 'Novi Sad', 'legenda@gmail.com',TRUE,'2023-09-12', 'Vukasin', '$2a$10$3tSEraKVYGNwhdpiC/oceu8c.GocIqREj68/9l.VeX3T6EYtb.kue', 'Profesionalan sef',  'Srbija', 'Dokmanovski', '0659443197', 1,2);
...
-- sifra je legenda11
--insert into registered_user(id, company_information, city, username,enabled, last_password_reset_date, name, password, profession,  state, surname, telephone_number, points, category,role_id) values (3, 'Iz dobre kompanije', 'Novi Sad', 'legenda+a@gmail.com', TRUE,'2023-09-12','Vukasin', '$2a$10$CYm0RizQmUvuLe97gx8a7ulcrlFvnKnLsvhDtrHv/GtCy15H7ZJeW', 'Profesionalan sef',  'Srbija', 'Dokmanovski', '0659443197', 0,0,1);
