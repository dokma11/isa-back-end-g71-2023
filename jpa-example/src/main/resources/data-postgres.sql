...
insert into company(id, address, average_grade, description, latitude, longitude, name) values (1, 'Mihala Babinke 4', 4.75, 'Jako dobra', 10.45, 45.67, 'Ninina kompanija');
insert into company(id, address, average_grade, description, latitude, longitude, name) values (2, 'Ulica i broj 54', 2.5, 'Onako', 11.45, 42.67, 'Neka kompanija');
insert into company(id, address, average_grade, description, latitude, longitude, name) values (3, 'Neka adresa', 3, 'Solidno', 10.45, 32.67, 'Naziv kompanije');
insert into company(id, address, average_grade, description, latitude, longitude, name) values (4, 'Alekse Santica 27', 4, 'Tu i tamo', 16.45, 48.67, 'Medical doo');
